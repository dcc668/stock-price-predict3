...
def lstm_mtm_model(feature_len, after_day, input_shape,batch_size,epochs,_class,scaler,
    ...
    validate_score = model.evaluate(
        x_validate, y_validate, batch_size=batch_size, verbose=0)
